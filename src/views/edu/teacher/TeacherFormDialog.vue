          ...
          <el-row :gutter="20">
            ...
            <el-col :span="12">
              <el-form-item label="职称" prop="titleId">
                <el-select v-model="formData.titleId" placeholder="请选择职称" clearable style="width: 100%">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="工作单位">
                <el-input v-model="formData.workUnit" placeholder="请输入工作单位" maxlength="200" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
...
} = useTeacherFormDialog(props, emit)
</script>
