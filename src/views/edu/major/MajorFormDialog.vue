<template>
  <YubDialog v-model="visible" :title="isEdit ? '编辑专业' : '新增专业'" width="750px" destroy-on-close @open="handleOpen">
      ...
      <el-tab-pane label="基本信息" name="basic">
        <el-form ref="formRef" :model="formData" :rules="rules" label-width="100px">
          ...
          <el-form-item label="说明" prop="description">
            <el-input v-model="formData.description" type="textarea" :rows="2" placeholder="请输入说明" maxlength="500"
              show-word-limit />
          </el-form-item>
