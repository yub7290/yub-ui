  ...
  <div class="recycle-page">
    <div class="table-wrapper">
      <div class="table-header">
        <div class="table-title">专业回收站</div>
      </div>
...
<script setup>
import { getRecycleMajorList, restoreMajor, deleteMajorRecycle } from '@/api/edu/recycle'
...
const { loading, tableData, handleRestore, handleDelete } = useRecycleManagement(
  getRecycleMajorList, restoreMajor, deleteMajorRecycle, '专业'
)
</script>
