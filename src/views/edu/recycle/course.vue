  ...
  <div class="recycle-page">
    <div class="table-wrapper">
      <div class="table-header">
        <div class="table-title">课程回收站</div>
      </div>
...
<script setup>
import { getRecycleCourseList, restoreCourse, deleteCourseRecycle } from '@/api/edu/recycle'
...
const { loading, tableData, handleRestore, handleDelete } = useRecycleManagement(
  getRecycleCourseList, restoreCourse, deleteCourseRecycle, '课程'
)
</script>
